...
function Mymarketplaceordersdetailsdetails() {
    ...
    const addFeedback = async (id) => {
        if(feedback===""){
            alert("Please add the feedback");
        } else {
            addDoc(collection(db,"marketplaceReviews"),{
                productId:id,
                review:feedback,
            }).then(()=>{
                    ...
                    return (
                        <div className='Mymarketplaceordersdetails'>
                            <div className='Mymarketplaceordersdetails-inner'>
                                ...
                                <br></br>
                                {Orders.orderStatus !== "Order Recieved Confirmed"?(<>
                                <br></br>
                                <hr></hr>
                                <br></br>
                                ...
                                {Orders.orderStatus === "Order Recieved Confirmed" ? (<>
                                    ...
                                    <hr></hr>
                                    <br></br>
                                    <h2 className='adminmarketplaceorderslist-h2'>Add a Customer Feedback</h2>
                                    <hr></hr>
                                    <br></br>
                                    <input onChange={(e)=>setFeedback(e.target.value)} placeholder='Add a Feedback' type="text" />
                                    <br></br>
                                    <br></br>
                                    <button onClick={()=>addFeedback(Orders.productId)} className='Mymarketplaceordersdetails-button'>Add Feedback</button>
                                </>) : (<></>)}
                            </div>
                        </div>
                    )
