                ...
                return (
                    <div className='Adminexchangeorderlistdetails'>
                        <div className='Adminexchangeorderlistdetails-inner'>
                            ...
                            <h3 onClick={() => copyToClipBoard(ex.transactionId)} className='Adminexchangeorderlistdetails-h3'>Transaction ID : {ex.transactionId}</h3>&nbsp;<a href='https://www.binance.com/en/my/wallet/history/deposit-crypto' target="_blank" rel="noopener noreferrer">check</a>
